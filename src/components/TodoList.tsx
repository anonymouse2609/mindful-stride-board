...
export default function TodoList() {
  ...
  return (
    <div className="section-card p-5 sm:p-6 flex flex-col gap-4" style={{ "--section-accent": "hsl(var(--accent))", "--section-glow": "hsla(38, 70%, 55%, 0.12)", animation: "fade-in 0.4s ease-out 0.2s forwards", opacity: 0 } as React.CSSProperties & Record<string, string>}>
      <h2 className="text-[17px] font-semibold text-foreground flex items-center gap-2">
        <div className="w-8 h-8 rounded-xl bg-accent/10 flex items-center justify-center">
          <ListTodo className="w-[18px] h-[18px] text-accent" />
        </div>
        Tasks
      </h2>
